...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.logo_pixmap = QPixmap('RegeAlb.png').scaled(150, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        self.popular_questions = ["What is Machine Learning?", "How do I become a machine learning engineer?"]
        ...
        # Add the popular question buttons
